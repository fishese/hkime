...
a method is disabled, overlapping or unclassified entries may be omitted. The
full audit is generated by `tools/MckAttributionReport.java` for manual review;
Pinyin is not enabled yet.
