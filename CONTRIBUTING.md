...
The method-membership hints were manually reviewed from factual codes; their original reference files are no longer available. New contributions should carry their own explicit method attribution rather than depend on reconstructing those files.
